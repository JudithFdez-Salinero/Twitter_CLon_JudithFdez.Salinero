...
const renderfiltered = () => {
  ...
  for (let i = 0; i < filterSearch.length; i++) {
    FeedTweetHTML += `  
       <div class="wrote">
         <img src="${filterSearch[i].avatar}" alt="User Icon">
         <div class="write_text">
           <div class="user_data">
             <h4>${filterSearch[i].full_name}</h4>
             <p>${filterSearch[i].user_name}</p>
             <svg xmlns="http://www.w3.org/2000/svg" width="4" height="4"
               <rect width="256" height="256" fill="none"></rect>
               <circle cx="128" cy="128" r="96" opacity="0.2"></circle>
               <circle cx="128" cy="128" r="96" fill="none" stroke="#fcfc
                 stroke-linejoin="round" stroke-width="16"></circle>
             </svg>
             <p>${filterSearch[i].hours}</p>
           </div>
           <div class="publication">
             <p>${filterSearch[i].tweet}</p>
             <div class="icons">
               <div class="icon_number">
                 <i class="ph-chat-circle"></i>
                 <p>${filterSearch[i].coments}</p>
               </div>
               <div class="icon_number">
                 <i class="ph-arrows-clockwise"></i>
                 <p>${filterSearch[i].retweet}</p>
               </div>
               <div class="icon_number">
                 <i class="ph-heart"></i>
                 <p>${filterSearch[i].likes}</p>
               </div>
             </div>
           </div>
         </div>
